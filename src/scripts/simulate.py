...
@click.option("--motor", default="aerotech_l1940x", help="The motor that provides thrust to the vehicle.")
@click.option("--hertz", default=100, help="The speed with which to run the software loop.")
