...
switch environment_inish.wind_profile
    ...
    case "trap"
        if altitude <= 9.5
            ...
            u_GL = environment_inish.u_inf;
            u_3000 = environment_inish.u_inf_3000;
            u_inf = u_GL + altitude*(u_3000 - u_GL)/3000;
        end
        theta = environment_inish.wind_direction;
        wind = [u_inf*cosd(theta); u_inf*sind(theta); 0];
end
...
environment.wind_direction = environment_inish.wind_direction; % wind direction counterclockwise from North, (°)
end
