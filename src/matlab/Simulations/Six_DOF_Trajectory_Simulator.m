...
environment_inish.u_inf = 0; % ft/s
...
vehicle.m = (684.8/16)/g; % total vehicle mass with full motor, slugs
...
hold on; grid on;
plot(t, x(7,:)*180/pi, 'LineWidth',sv.LineWidth1,'Color',sv.Blue, 'DisplayName', 'Pitch, \theta');
plot(t, x(8,:)*180/pi, 'LineWidth',sv.LineWidth1,'Color',sv.Orange, 'DisplayName', 'Roll, \phi');
